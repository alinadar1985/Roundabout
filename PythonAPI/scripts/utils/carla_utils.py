...
#../../../CARLA_0.9.10/WindowsNoEditor/PythonAPI/carla/dist/carla-*%d.%d-%s.egg
try:
    sys.path.append("C:/Users/alina/Desktop/carla/CARLA_0.9.10/WindowsNoEditor/PythonAPI/carla/dist/carla-0.9.10-py3.7-win-amd64.egg")
except IndexError:
    pass
...
class ClientSideBoundingBoxes(object):
    ...
    def draw_bounding_boxes(image, bounding_boxes):
        ...
        for bbox in bounding_boxes:
            ...
            # draw lines
            # base
            image = cv2.line(cv2.UMat(image), points[0], points[1], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[1], points[2], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[2], points[3], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[3], points[0], (0, 255, 0), 1)
            # top
            image = cv2.line(cv2.UMat(image), points[4], points[5], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[5], points[6], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[6], points[7], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[7], points[4], (0, 255, 0), 1)
            
            # base-top
            image = cv2.line(cv2.UMat(image), points[0], points[4], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[1], points[5], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[2], points[6], (0, 255, 0), 1)
            image = cv2.line(cv2.UMat(image), points[3], points[7], (0, 255, 0), 1)
