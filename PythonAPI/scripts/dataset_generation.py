...
def run_use_case(use_case: str, output_file_path: str, sensor_list: list, sim_params: dict,
    ...
    try:
        ...
        with CarlaSyncMode(world, sensor_actors, fps=sim_params['fps']) as sync_mode:
            ...
            ego_vehicle.set_target_velocity(carla.Vector3D(0.0, sim_params['ego_velocity'], 0))

            for idx, opponent in enumerate(opponent_actors):
                opponent.set_target_velocity(carla.Vector3D(0.0, opponents_velocities[idx], 0))
...
if __name__ == "__main__":
    DataStorageReader = "../dataset/data_usecase5.h5"
    use_case = USE_CASE_4
